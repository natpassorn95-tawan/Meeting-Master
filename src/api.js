...
export const api = {
  ...
  checkConflicts: (body) => post("/meetings/check-conflicts", body),
  ...
  notifyUpdate: (id) => post(`/meetings/${id}/notify-update`),
  ...
  notifyBatch: (scheduleIds) => post("/schedules/notify-batch", { scheduleIds }),
